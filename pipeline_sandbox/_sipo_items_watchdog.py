...
runs thrash memory and crash the machine):
  ./.venv/Scripts/python.exe pipeline_sandbox/_sipo_items_watchdog.py ff fg sf lab green socdem pbp aontu
"""
...
ETL = ROOT / "pipeline_sandbox/sipo_expense_items_paddle_etl.py"
CKPT = ROOT / "pipeline_sandbox/_sipo_output/by_party/_ckpt_items"
...
def run_party(key: str) -> bool:
    log = ROOT / f"pipeline_sandbox/_sipo_output/_log_items_{key}.txt"
    restarts = 0
