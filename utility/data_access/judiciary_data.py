"""Judiciary legal-diary data access — thin framework-neutral cached wrapper over dail_tracker_core.

Retrieval SQL + QueryResult handling live in
``dail_tracker_core.queries.judiciary``; this file owns only framework-neutral caching
