...
CLI:
    python -m corporate.cro_poller                # poll + download if newer
    python -m corporate.cro_poller --force        # download even if we already hold it
    python -m corporate.cro_poller --check-only   # report whether an update is available; no download
"""
