# Known stale as of 2026-08-14: the matching logic below (nearest/_best_within/
# _spatial_temporal_matches) was extracted to planning_appeal_vector.py and rewritten as
# vectorized Polars; this copy predates that move. The all-zero hash never matches a real
# file, so assert_fresh() always refuses this session until it's genuinely refreshed and
# rehashed with `python tools/mutation_session.py --rehash planning-appeal-outcomes-full`.
