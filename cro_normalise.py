...
- name_norm: upper, strip punctuation, drop common legal suffixes / corporate
  fillers, collapse whitespace. Rule is local to this script — the project's
  shared normalise_join_key.py is intentionally not imported (the CRO universe
  is too dissimilar to TD names for a shared key).
