...
Validated approach (doc/archive/SIPO_OCR_REMAINING_QUEUE.md): the scans are crisp; Tesseract
...
def parse_party(key: str, party: str, pdf_name: str, norm_keys, norm_to_name, name_to_seats) -> pl.DataFrame:
    ...
    if df.height:
        ...
        # doc/archive/SIPO_OCR_REMAINING_QUEUE.md). A candidate-expenses fact with no candidate
