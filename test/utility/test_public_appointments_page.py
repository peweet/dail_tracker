...
def _appt_df() -> pd.DataFrame:
    df = pd.DataFrame(
        [
            {
                "notice_ref": "PA-1",
                "issue_date": pd.Timestamp("2024-03-01"),
                "appointing_authority": "Government",
                "appointment_type": "state_board",
                "body": "An Bord Pleanála",
                "appointee": "Jane Doe; John Roe",
                "appointee_count": 2,
                "role": "Member",
                "portfolio": "",
                "english_summary": "Appointment of two members",
                "lang": "Irish",
                "title": "FÓGRA // Ceapachán",
                "iris_source_pdf": "Iris-1.pdf",
            },
            {
                "notice_ref": "",
                "issue_date": pd.Timestamp("2023-07-15"),
                "appointing_authority": "Minister",
                "appointment_type": "special_adviser",
                "body": "Dept of Health",
                "appointee": "Mary Bloggs",
                "appointee_count": 1,
                "role": "Special Adviser",
                "portfolio": "Health",
                "english_summary": "Adviser appointed",
                "lang": "English",
                "title": "Notice of appointment",
                "iris_source_pdf": "Iris-2.pdf",
            },
        ]
    )
        ...
        [
            {
                ...
                "body": "HIQA",
                "body_full": "Health Information and Quality Authority",
                "member_name": "Anne Daly",
                "position_type": "Chairperson",
                "basis_of_appointment": "PAS Process",
                "first_appointed": "2022-01-10",
                "expiry_date": "2027-01-09",
                "source_url": "https://x",
                "wikidata_qid": "Q1",
                "wikidata_url": "https://www.wikidata.org/wiki/Q1",
                "wikidata_label": "Anne Daly",
                "wikidata_description": "Irish academic",
                "wikidata_occupations": "academic; economist",
                "wikidata_employers": "",
                "wikidata_positions_held": "",
                "wikidata_curation_note": "verified",
            },
            {
                "department": "Department of Health",
                "body": "HIQA",
                "body_full": "Health Information and Quality Authority",
                "member_name": "Brian Nolan",
                "position_type": "Board Member",
                "basis_of_appointment": "Appointed by the Minister",
                "first_appointed": "2023-05-01",
                ...
                "wikidata_occupations": None,
                "wikidata_employers": None,
                "wikidata_positions_held": None,
                "wikidata_curation_note": None,
            },
            {
                "department": "Department of Finance",
                "body": "NTMA",
                "body_full": "National Treasury Management Agency",
                "member_name": "Cara Walsh",
                "position_type": "Ordinary Member",
                "basis_of_appointment": "Ministerial Appointment",
                "first_appointed": "2021-09-15",
        ...
        [
            {
                ...
                "body": "HIQA",
                "body_full": "Health Information and Quality Authority",
                "legal_basis": "Health Act 2007",
                "legal_basis_url": "https://law",
                "max_positions": 12,
                "gender_female_n": 6,
                "gender_male_n": 6,
            ...
            },
            {
                ...
                "gender_female_n": 3,
                "gender_male_n": 6,
                "gender_female_pct": 33.0,
                "gender_male_pct": 67.0,
                "members_listed": 9,
                "source_url": "https://x",
            },
        ]
