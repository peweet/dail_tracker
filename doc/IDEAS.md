...
- **Corporate notices page (insolvency/examinership/ICAV)** | 📋 design locked, ETL prereqs done | ~35,894 notices + brand→parent-fund tagging → "who's calling in Irish loans" ranking + per-company search. *Caveat: ALL personal insolvency excluded (privacy); entity_name 75% clean; journalist/researcher tilt.* | `corporate_feature` (supersedes `company_register_notices_feature`)
