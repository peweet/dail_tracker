...
from dail_tracker_core.siting.engine import SitingResult
from dail_tracker_core.siting.engine import evaluate as _evaluate
...
def evaluate_site(
    ...
    return _evaluate(lon, lat, dev_type, num_units=num_units, floor_area_m2=floor_area_m2, store=_STORE)
