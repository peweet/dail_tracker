...
SELECT
    ...
    -- TODO_PIPELINE_VIEW_REQUIRED: latest_fetch_timestamp_utc, mart_version, code_version
    'Oireachtas Parliamentary Standard Allowance Records (TAA + PRA + Ministerial)' AS source_summary,
