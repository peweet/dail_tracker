"""Lobbying data access — thin framework-neutral cached wrapper over dail_tracker_core.

Retrieval SQL + QueryResult state-handling live in
``dail_tracker_core.queries.lobbying``; this file owns only framework-neutral caching
