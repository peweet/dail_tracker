...
FLAGGED = [
    ...
    "apps/planspec-demo/README.md",
    "apps/planspec-demo/public/app.js",
    "apps/public-signal/README.md",
    "apps/public-signal/worker/index.js",
    "test/apps/test_publicsignal_private_api.py",
