"""SIPO GE2024 national-agent ITEMISED-EXPENSES extractor (sandbox).
...
Sandbox only — NOT gold.

Run (party keys; default all):
  ./.venv/Scripts/python.exe pipeline_sandbox/sipo_expense_items_paddle_etl.py ff
  ./.venv/Scripts/python.exe pipeline_sandbox/sipo_expense_items_paddle_etl.py
"""
