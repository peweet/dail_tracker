"""SIPO 2024 election DONATIONS extractor — cache+parse (sandbox).
...
Run:
  cache:   ./.venv/Scripts/python.exe pipeline_sandbox/sipo_donations_paddle_etl.py cache
  parse:   ./.venv/Scripts/python.exe pipeline_sandbox/sipo_donations_paddle_etl.py parse
  both:    ./.venv/Scripts/python.exe pipeline_sandbox/sipo_donations_paddle_etl.py
