...
Usage
-----
    python tools/migration/extract_class_contract.py                 # markdown to stdout
    python tools/migration/extract_class_contract.py -o doc/CLASS_CONTRACT.md
    python tools/migration/extract_class_contract.py --check         # fail on new unstyled classes
    python tools/migration/extract_class_contract.py --orphans       # dead + unstyled detail
"""
...
def build_report(show_orphans: bool) -> str:
    ...
    w("> Verify with `python tools/migration/extract_class_contract.py --check`.\n")
    w(
    ...
    if args.check or args.update_baseline:
        ...
        if args.update_baseline:
            ...
            lines = [
                ...
                "# Generated by tools/migration/extract_class_contract.py --update-baseline.",
