...
ATTENDANCE: list[tuple[str, str]] = [
    ...
    (
        ...
        f"{_TAA}/2026/2026-03-06_deputies-verification-of-attendance-for-the-payment-of-taa-01-january-2026-to-31-january-2026_en.pdf",
    ),
    (
    ...
    (
        ...
        f"{_TAA}/2025/2025-04-09_deputies-verification-of-attendance-for-the-payment-of-taa-01-january-2025-to-31-january-2025_en.pdf",
    ),
    (
        "29 Nov 2024 – 31 Dec 2024",
        f"{_TAA}/2025/2025-02-28_deputies-verification-of-attendance-for-the-payment-of-taa-29-november-2024-to-31-december-2024_en.pdf",
    ),
    (
        "1 Jan 2024 – 8 Nov 2024",
        f"{_TAA}/2025/2025-02-17_deputies-verification-of-attendance-for-the-payment-of-taa-01-january-2024-to-08-november-2024_en.pdf",
    ),
    (
        "1 Jan 2023 – 31 Dec 2023",
        f"{_TAA}/2024/2024-02-01_deputies-verification-of-attendance-for-the-payment-of-taa-01-january-2023-to-31-december-2023_en.pdf",
    ),
]
...
PAYMENTS: list[tuple[str, str]] = [
    ...
    (
        "Jan 2026",
        f"{_PSA}/2026/2026-03-06_parliamentary-standard-allowance-payments-to-deputies-for-january-2026_en.pdf",
    ),
    (
        "Dec 2025",
        f"{_PSA}/2026/2026-02-16_parliamentary-standard-allowance-payments-to-deputies-for-december-2025_en.pdf",
    ),
    (
        "Nov 2025",
    ...
    (
        "Sep 2025",
        f"{_PSA}/2025/2025-11-18_parliamentary-standard-allowance-payments-to-deputies-for-september-2025_en.pdf",
    ),
    (
        "Aug 2025",
        f"{_PSA}/2025/2025-10-06_parliamentary-standard-allowance-payments-to-deputies-for-august-2025_en.pdf",
    ),
    ...
    (
        "Jan 2025",
        f"{_PSA}/2025/2025-04-09_parliamentary-standard-allowance-payments-to-deputies-for-january-2025_en.pdf",
    ),
    (
        "Dec 2024",
        f"{_PSA}/2025/2025-02-28_parliamentary-standard-allowance-payments-to-deputies-for-1-31-december-2024_en.pdf",
    ),
    (
        "29–30 Nov 2024",
        f"{_PSA}/2025/2025-02-28_parliamentary-standard-allowance-payments-to-deputies-for-29-30-november-2024_en.pdf",
    ),
    (
        "1–8 Nov 2024",
        f"{_PSA}/2025/2025-02-17_parliamentary-standard-allowance-payments-to-deputies-for-1-8-november-2024_en.pdf",
    ),
    (
        "Oct 2024",
        f"{_PSA}/2024/2024-12-16_parliamentary-standard-allowance-payments-to-deputies-for-october-2024_en.pdf",
    ),
    (
        "Sep 2024",
        f"{_PSA}/2024/2024-11-01_parliamentary-standard-allowance-payments-to-deputies-for-september-2024_en.pdf",
    ),
    (
        "Aug 2024",
        f"{_PSA}/2024/2024-10-11_parliamentary-standard-allowance-payments-to-deputies-for-august-2024_en.pdf",
    ),
    ...
    (
        "Feb 2024",
        f"{_PSA}/2024/2024-04-02_parliamentary-standard-allowance-payments-to-deputies-for-february-2024_en.pdf",
    ),
    (
        "Jan 2024",
        f"{_PSA}/2024/2024-03-01_parliamentary-standard-allowance-payments-to-deputies-for-january-2024_en.pdf",
    ),
    (
        "Dec 2023",
        f"{_PSA}/2024/2024-02-01_parliamentary-standard-allowance-payments-to-deputies-for-december-2023_en.pdf",
    ),
    (
        "Nov 2023",
        f"{_PSA}/2024/2024-02-01_parliamentary-standard-allowance-payments-to-deputies-for-november-2023_en.pdf",
    ),
    (
        "Oct 2023",
        f"{_PSA}/2023/2023-12-01_parliamentary-standard-allowance-payments-to-deputies-for-october-2023_en.pdf",
    ),
    (
        "Sep 2023",
        f"{_PSA}/2023/2023-10-27_parliamentary-standard-allowance-payments-to-deputies-for-september-2023_en.pdf",
    ),
    (
        "Aug 2023",
        f"{_PSA}/2023/2023-10-01_parliamentary-standard-allowance-payments-to-deputies-for-august-2023_en.pdf",
    ),
    ...
    (
        "Apr 2023",
        f"{_OTHER}/2023/2023-06-01_parliamentary-standard-allowance-payments-to-deputies-for-april-2023_en.pdf",
    ),
    (
        "Mar 2023",
        f"{_OTHER}/2023/2023-05-01_parliamentary-standard-allowance-payments-to-deputies-for-march-2023_en.pdf",
    ),
    (
        "Feb 2023",
        f"{_OTHER}/2023/2023-04-01_parliamentary-standard-allowance-payments-to-deputies-for-february-2023_en.pdf",
    ),
    (
        "Jan 2023",
        f"{_OTHER}/2023/2023-04-01_parliamentary-standard-allowance-payments-to-deputies-for-january-2023_en.pdf",
    ),
    (
        "Dec 2022",
        f"{_OTHER}/2023/2023-03-13_parliamentary-standard-allowance-payments-to-deputies-for-december-2022_en.pdf",
    ),
    (
        "Nov 2022",
        f"{_OTHER}/2023/2023-01-03_parliamentary-standard-allowance-payments-to-deputies-for-november-2022_en.pdf",
    ),
    (
        "Oct 2022",
        f"{_PSA}/2022/2022-12-06_parliamentary-standard-allowance-payments-to-deputies-for-october-2022_en.pdf",
    ),
    (
        "Sep 2022",
        f"{_PSA}/2022/2022-11-14_parliamentary-standard-allowance-payments-to-deputies-for-september-2022_en.pdf",
    ),
    (
        "Aug 2022",
        f"{_PSA}/2022/2022-10-01_parliamentary-standard-allowance-payments-to-deputies-for-august-2022_en.pdf",
    ),
    ...
    (
        "Feb 2022",
        f"{_PSA}/2022/2022-04-19_parliamentary-standard-allowance-payments-to-deputies-for-february-2022_en.pdf",
    ),
    (
        "Jan 2022",
        f"{_PSA}/2022/2022-03-16_parliamentary-standard-allowance-payments-to-deputies-for-january-2022_en.pdf",
    ),
    (
        "Dec 2021",
        f"{_PSA}/2022/2022-03-10_parliamentary-standard-allowance-payments-to-deputies-for-december-2021_en.pdf",
    ),
    (
        "Nov 2021",
        f"{_PSA}/2022/2022-01-13_parliamentary-standard-allowance-payments-to-deputies-for-november-2021_en.pdf",
    ),
    (
        "Oct 2021",
        f"{_PSA}/2021/2021-12-22_parliamentary-standard-allowance-payments-to-deputies-for-october-2021_en.pdf",
    ),
    (
        "Sep 2021",
        f"{_PSA}/2021/2021-12-10_parliamentary-standard-allowance-payments-to-deputies-for-september-2021_en.pdf",
    ),
    (
        "Aug 2021",
        f"{_PSA}/2021/2021-10-12_parliamentary-standard-allowance-payments-to-deputies-for-august-2021_en.pdf",
    ),
    ...
    (
        "Feb 2021",
        f"{_PSA}/2021/2021-05-27_parliamentary-standard-allowance-payments-to-deputies-for-february-2021_en.pdf",
    ),
    (
        "Jan 2021",
        f"{_PSA}/2021/2021-05-27_parliamentary-standard-allowance-payments-to-deputies-for-january-2021_en.pdf",
    ),
    (
        "Dec 2020",
        f"{_PSA}/2021/2021-05-27_parliamentary-standard-allowance-payments-to-deputies-for-december-2020_en.pdf",
    ),
    (
        "Nov 2020",
        f"{_PSA}/2021/2021-02-12_parliamentary-standard-allowance-payments-to-deputies-for-november-2020_en.pdf",
    ),
    (
        "Oct 2020",
        f"{_PSA}/2020/2020-12-03_parliamentary-standard-allowance-payments-to-deputies-for-october-2020_en.pdf",
    ),
    (
        "Sep 2020",
        f"{_PSA}/2020/2020-12-03_parliamentary-standard-allowance-payments-to-deputies-for-september-2020_en.pdf",
    ),
    (
        "Aug 2020",
        f"{_PSA}/2020/2020-10-21_parliamentary-standard-allowance-payments-to-deputies-for-august-2020_en.pdf",
    ),
    ...
    (
        "Feb 2020",
        f"{_PSA}/2020/2020-04-01_parliamentary-standard-allowance-payments-to-deputies-for-february-2020_en.pdf",
    ),
    (
        "Jan 2020",
        f"{_PSA}/2020/2020-03-01_parliamentary-standard-allowance-payments-to-deputies-for-january-2020_en.pdf",
    ),
]
...
def render_pdf_source_links(links: list[tuple[str, str]]) -> None:
    ...
    rows = "".join(
        f'<div style="padding:0.28rem 0;border-bottom:1px solid var(--border)">{source_link_html(url, label)}</div>'
