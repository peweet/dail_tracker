"""Your-Councillors data access — thin framework-neutral cache adapter (firewall-clean).
...
@cache_data(ttl=600)
def fetch_plan_directions(la: str) -> QueryResult:
    return _q.plan_directions(get_constituency_conn(), la)
