...
from ui.components import dt_page, hero_banner, search_matches
...
GLOSSARY_TERMS: dict[str, str] = {
    ...
    "AFS": "Annual Financial Statement — a council's audited whole-year accounts, showing its total income and spending across every service. The source for council-wide budget figures on this site, distinct from individual purchase orders.",
    ...
    "An Bord Pleanála / An Coimisiún Pleanála": "The national planning appeals board — it decides appeals against local-authority planning decisions and rules on large infrastructure. Being renamed An Coimisiún Pleanála (ACP) under the Planning and Development Act 2024; older appeals and records still carry the An Bord Pleanála (ABP) name.",
    ...
    "C&AG": "Comptroller & Auditor General — the independent State auditor that examines how government departments and public bodies spend public money, and reports to the Dáil. Its reports are used as a benchmark on this site.",
    ...
    "Development Plan": "The statutory land-use plan each county or city council adopts, setting out where development may happen and under what conditions over a six-year period. Planning applications are judged against it.",
    "DHLGH": "Department of Housing, Local Government and Heritage — the government department responsible for housing policy, planning, and local authorities. Source of several housing and council datasets shown here.",
    ...
    "EPA": "Environmental Protection Agency — the State body that licenses and enforces controls on activities that can pollute, such as waste, industry, and large farms. An EPA licence is a public record of who is permitted to operate such a site.",
    ...
    "FOI": "Freedom of Information — the right, under the FOI Act 2014, to request records held by public bodies. Some datasets here originate from FOI publication schemes or released records.",
    ...
    "HAP": "Housing Assistance Payment — a State subsidy that helps eligible households pay rent to a private landlord, administered by local authorities. It has largely replaced older rent supplements.",
    "HIQA": "Health Information and Quality Authority — the independent regulator that inspects and reports on health and social-care services, including asylum-accommodation and nursing-home settings.",
    "HSE": "Health Service Executive — the body that runs Ireland's public health and social-care services. One of the largest publishers of purchase-order spending shown here.",
    ...
    "IPAS": "International Protection Accommodation Services — the State body, within the Department of Children, that houses people seeking international protection. Source of the accommodation and arrivals figures on the asylum page.",
    ...
    "LEAP": "The EPA's public online register of environmental licences, applications, and enforcement actions, searchable by company or site.",
    "LGAS": "Local Government Audit Service — the independent auditors that examine each council's annual accounts and publish a statutory audit opinion on them. Quoted on the council pages.",
    ...
    "LPT": "Local Property Tax — an annual tax on residential property, part-retained by the local council to help fund local services.",
    ...
    "PPP": "Public-Private Partnership — an arrangement where a private company finances, builds, and often operates public infrastructure (a road, school, or building) in return for payments over many years, usually through a special-purpose vehicle.",
    ...
    "SCSI": "Society of Chartered Surveyors Ireland — the professional body for surveyors. Its tender-price index tracks how construction costs change over time, used here to put contract values in context.",
    ...
    "Tusla": "The Child and Family Agency — the State body responsible for child protection, family support, and related services.",
