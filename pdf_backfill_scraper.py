...
USER_AGENT = "dail-tracker-bot/0.1 (+https://github.com/<owner>/dail-extractor; mailto:<contact>)"
...
PUBLICATIONS_INDEX = "https://www.oireachtas.ie/en/publications/?topic[]=parliamentary-allowances&resultsPerPage=50"
...
def try_construction(
    ...
    """
    for attempts, candidate in enumerate(construct_candidates(data_year, data_month)):
