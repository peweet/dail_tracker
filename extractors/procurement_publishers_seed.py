...
def _row(
    pid, name, ptype, sector, url, *, status="NEEDS_MANUAL_CHECK", privacy_risk="low", notes="", caveat=""
) -> dict:
...
SEEDS: list[dict] = [
    ...
    _row(
        ...
        "",
        status=NF,
        notes="parent group; landing page for PO/payments not yet located",
    ),
    _row(
        "ie_irishrail",
        "Iarnród Éireann",
        ...
        status="FOI_AIE_CONFIRMED_EXISTS",
        notes="FOI publication-scheme PDF clue; not a clean file list",
    ),
    ...
    _row(
        ...
        "https://ocei.ie/",
        status=FOI,
        notes="AIE/OCEI route only per plan; no clean PO file list located",
    ),
    _row(
        "ie_coillte",
        "Coillte",
    ...
    _row(
        ...
        status=FOI,
        notes="FOI disclosure logs per plan",
    ),
    ...
    _row(
        "dept_dper",
        "Dept of Public Expenditure / OGCIO / OGP",
        "department",
        "central_government",
    ...
    _row(
        ...
        notes="compliance/payments page",
    ),
    _row(
        "ie_cib",
    ...
    _row("ie_rsa", "Road Safety Authority", "agency", "transport", "https://www.rsa.ie/about/reporting"),
    _row(
        "ie_screen",
        "Screen Ireland",
        "agency",
        ...
        privacy_risk="medium",
        notes="film funding; payees may be individuals/production cos",
    ),
    _row(
        "ie_arts_council",
        "Arts Council",
    ...
    _row(
        ...
        privacy_risk="high",
        notes="procurement landing; high public-interest, supplier-rich, but formats vary",
    ),
    _row(
        "ie_ntpf",
    ...
    _row(
        ...
        "agency",
        "social",
        "https://www.pobal.ie/financial-information/",
        privacy_risk="medium",
