"""Votes data access — thin framework-neutral cached wrapper over dail_tracker_core.
...
framework-neutral caching, the connection (with the chamber parquet substitutions), and
