"""Local-government ("Who runs your county") data access — thin framework-neutral cached wrapper.

Owns only framework-neutral caching. All retrieval SQL lives in
...
@cache_data(ttl=300)
def fetch_noac_indicators_result(la: str) -> QueryResult:
    return _q.noac_indicators(get_constituency_conn(), la)
