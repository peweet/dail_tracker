...
def get_interests_conn() -> duckdb.DuckDBPyConnection:
    ...
    # the 2026-07-10 lesson that a loud supplements registration took down every
    # interests page on Cloud when the view SQL shipped before its parquet.
    return domain_conn("interests")
