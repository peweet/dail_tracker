...
_AWARDS_COLS = [
    ...
    "value_safe_to_sum",
    # call-off carriage + the 2026-06-12 detail widening. The numeric-looking detail
    # columns are STRINGS here because the extractor reads the CSV with
    # infer_schema_length=0 — the view's TRY_CASTs are part of the contract under test.
    "Parent Agreement ID",
    "is_call_off",
...
PROCUREMENT_AWARDS = pl.DataFrame(
    [
        # Acme T001 carries the FULL detail set so the view's renames/TRY_CASTs are
        # asserted exactly (title, procedure, 24-month term, 5 bids, TED links, estimate).
        _award(
            "T001",
            ...
            False,
            True,
            title="N4 Road Improvement Works – Phase 2",
            spend_cat="Minor Building Works and Civils",
            contract_type="Works",
        ...
        _award(
            ...
            False,
            False,
            title="Managed Facilities Services Framework",
            spend_cat="Managed Services",
        ...
        # Nullid also has NO CPV (the real corpus: ~70% of award rows) but DOES carry an
        # OGP Spend Category → category_label falls back to it, and the per-CPV rollup
        # must NOT grow a null/"NULL" bucket from this row.
        _award(
            None,
            "Nullid Co Ltd",
            "nullidcoltd",
            ...
            False,
            False,
            title="Legacy Case Management System Support",
            spend_cat="Information and Communication Technology",
        ),
        _award(
            "T005",
            "Joe Murphy",
        ...
        _award(
            ...
            False,
            True,
            title="Public Affairs Monitoring Services",
        ),
        _award(
            "T008",
            "Mason & Sons Ltd",
            ...
            False,
            True,
            title="Library Building Fit-Out",
        ),
    ],
    schema_overrides={
        "Tender ID": pl.String,
        ...
        "Parent Agreement ID": pl.String,
        "is_call_off": pl.Boolean,
