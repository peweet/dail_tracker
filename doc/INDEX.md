...
65 docs · ~334.6k tokens total · 24 LIVE · 26 superseded/stale · 15 unclassified. **Never read a doc whole to find out if it's relevant — scan this table, then open with `offset`/`limit` or grep the `key:` line.**
...
| [AGENT_HARNESS.md](AGENT_HARNESS.md) | infra | 2.0k | 2026-08-05 | changing reusable agent prompts, hooks, subagent roles, or the coding-agent evaluation harness |
