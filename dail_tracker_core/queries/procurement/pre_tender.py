...
def pre_tender_leads(
    ...
    *,
    ...
    return _run(
        ...
        + where
        + " ORDER BY stage_display_order, source_date DESC NULLS LAST, project_name LIMIT ?",
        params,
    )
...
def pre_tender_work_packages(
    ...
    *,
    ...
    return _run(
        ...
        + where
        + " ORDER BY package_group, package_label, source_date DESC NULLS LAST, project_name LIMIT ?",
        params,
    )
